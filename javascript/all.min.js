...
createImage(d,c,e[0]/a,e[1]/a,b[0]/a,b[1]/a)})});$(window).konami({code:[55,55,55],cheat:function(){$(".banana").slideDown()}});function createImage(a,b,e,d,c,g){var f=new Image;f.src="images/object/"+a+".png";a=new Image;a.src=b;b=document.getElementById("result");b.width=500;b.height=500;var h=b.getContext("2d");h.rect(0,0,500,500);h.fillStyle="#CCCCCC";h.fill();h.drawImage(a,e,d,c,g);h.drawImage(f,0,0,500,500);e=b.toDataURL("image/png");$("#download").attr("href",e);$("#download")[0].click()}
