var $userimage=$("#userimage .inner"),$coverimage=$("#coverimage .inner"),$dragger=$("#dragger"),$sizer=$("#size-slider"),$loading=$("#loading");$(window).load(function(){var a=$userimage.width(),b=getImgSize(getBackgroundImage($userimage));resizeDragger(b,a)});
...
function handleFileSelect(a){a.stopPropagation();a.preventDefault();loadImage(a.dataTransfer.files)}function handleDragOver(a){a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="copy"}$("#show").click(function(){"1200"==$(".preview").css("z-index")?$(".preview").css("z-index","-9999").css("opacity",0):"-9999"==$(".preview").css("z-index")&&$(".preview").css("z-index","1200").css("opacity",1)});
$(window).scroll(function(a){a=$(window).scrollTop();var b=$(window).height();a>b?$(".gototop").show():$(".gototop").hide()});$(".gototop").click(function(){$("html,body").animate({scrollTop:0},"fast")});
...
b,a);$loading.hide()})}$loading.show();var c,d;"function"!==typeof window.FileReader?alert("\u60b2\u5287\uff01\u60a8\u7684\u700f\u89bd\u5668\u592a\u53e4\u8001\u4e86\uff0c\u7121\u6cd5\u904b\u884c\u6211\u5011\u7684\u670d\u52d9\uff01"):a?(a=a[0],c=new FileReader,c.onload=b,c.readAsDataURL(a)):alert("\u60b2\u5287\uff01\u60a8\u7684\u700f\u89bd\u5668\u4e0d\u652f\u63f4\u6a94\u6848\u4e0a\u50b3\uff01")}function getImgSize(a){var b=new Image;b.src=a;return[b.width,b.height]}
function getBackgroundImage(a){return a.css("background-image").replace(/^url\(["']?/,"").replace(/["']?\)$/,"")}
