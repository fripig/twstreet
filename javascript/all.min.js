...
")");1==$userimage.hasClass("dragged")?$userimage.attr("class","inner dragged"):$userimage.attr("class","inner");$("<img/>").attr("src",getBackgroundImage($userimage)).load(function(){var b=[this.width,this.height],e=$userimage.width();resizeDragger(b,e,a)})});$("#normalSubmit").click(function(){var a=$userimage.width(),b=getBackgroundSize($userimage.css("background-size")),e=getBackgroundPosition($userimage.css("background-position")),a=a/500,d=$("input[name=template]:checked").val(),c=$("#source").val();
createImage(d,c,e[0]/a,e[1]/a,b[0]/a,b[1]/a)})});function createImage(a,b,e,d,c,g){var f=new Image;f.src="images/object/"+a+".png";a=new Image;a.src=b;b=document.getElementById("result");b.width=500;b.height=500;var h=b.getContext("2d");h.rect(0,0,500,500);h.fillStyle="#CCCCCC";h.fill();h.drawImage(a,e,d,c,g);h.drawImage(f,0,0,500,500);e=b.toDataURL("image/png");$("#download").attr("href",e);$("#download")[0].click()}
